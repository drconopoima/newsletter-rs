...
pub fn run(
    ...
    postgres_pool: Pool,
    smtp_pool: Option<SmtpTransport>,
    ...
    let smtp_pool: Arc<Option<SmtpTransport>> = Arc::new(smtp_pool);
    ...
    if admin_bind_address.is_none() {
        let server = HttpServer::new(move || {
            ...
            let smtp_pool_readiness = smtp_pool.clone();
            ...
            App::new()
                ...
                // Register the SMTP server pooled connection as part of application state
                .app_data(smtp_pool.clone())
    ...
    let smtp_pool1 = smtp_pool.clone();
